...
const Position: FC = () => {
    return (
        <div className="w-full">
            <div className="font-bold text-30 w-full text-center mt-80 mb-10">Position 位置</div>
            <div className="position-wrapper bg-gray1 h-full relative flex flex-row ">
                <div className="position-item1 position-item">
                    <div className="font-bold text-25 w-full h-full text-center mb-10 flex flex-col  justify-center">
                        One: Fixed
                    </div>
                </div>
